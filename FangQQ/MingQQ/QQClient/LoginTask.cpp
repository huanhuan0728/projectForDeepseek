...
Ret0:
	...
	nLoginResultCode = QLRC_SUCCESS;
	lpBuddyListResult = new CBuddyListResult;
	OfflineInit(lpBuddyListResult);//离线初始化（后续可删除）
...
void CLoginTask::OfflineInit(CBuddyListResult * pBuddy)
{
	CBuffer buffer;
	buffer.Add("{\"retcode\":0,\"result\":{\"categories\":[{\"index\":0,\"sort\":0,\"name\":\"bingo\"}],\"friends\":[{\"uin\":6282371},{\"uin\":1016555038}]}}");
	pBuddy->Parse(&buffer);
}
